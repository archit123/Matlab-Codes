...
pnames = {   'distance' 'start'   'maxiter'  'replicates' 'emptyaction' 'onlinephase' 'clustermaxiter'};
dflts =  {'sqeuclidean' 'sample'       []        []        'error'         'off'            []        };
[eid,errmsg,distance,start,maxit,reps,emptyact,online,clustermaxit] = getargs(pnames, dflts, varargin{:});
if ~isempty(eid)
